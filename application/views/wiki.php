...
<link rel="stylesheet" type="text/css" href="<?php echo base_url();?>public/common/css/wiki.css"/>
<div class="main cl">
	...
	<div class="main-left fl">
        <div class="news-list">
        	...
        	<div class="news cl">
            	<h4><span class="category"><a href="<?php echo site_url('home/wks/' . $val['catalog_id']);?>"><?php echo $val['catalog_name'];?></a></span><a href="<?php echo site_url('post/' . $val['id']) ?>"><?php echo $val['title'] ?></a></h4>
                ...
                <div class="fr wiki-description">
                    <p><?php echo mb_substr($val['intro'], 0, 100); ?>...<a href="<?php echo site_url('post/' . $val['id']) ?>" target="_blank">Read More >></a></p>
                    <div class="tags">标签：
                        <?php
                            if($val['tags']) {
