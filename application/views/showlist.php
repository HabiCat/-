...
<form name="searchForm" id="searchForm" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
    ...
    <input name="submit1" id="submit1" onclick="gotoSearch()" type="button" value="查  找" size=30 />
</form>
<div id="list">
...
<script type="text/javascript">
    ...
    function gotoPage(page) {
        ...
        $.ajax({
            type: "POST",
            url: '<?php echo $this->input->server('PHP_SELF') . '?inajax=1' ?>',
            data: {'title' : $('#title').val(), 'page' : page},
