...
<form name="xform" id="xform" action="<?php echo site_url('admin/useredit/' . $user['id']) ?>" method="post">
    <table class="form_table">
        ...
        <tr>
            <td><input size="30" maxlength="50" name="Admin[email]" id="Admin_email" type="text" value="<?php echo $user['email'] ?>"></td>
        </tr>
        <tr class="submit">
